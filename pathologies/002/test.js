...
function testing123(){
  ...
  for(let i = 0; i < uniqueIntegers.length; i = i + 2){
    console.log(265, i, uniqueIntegers[i])
    //console.log(267)
  ...
  it1[Symbol.iterator] = AVL.ITER_FWD_EQ_TO_LE
  it1.ITER_LB = 5
  it1.ITER_UB = 7
  expect(
    [...it1].map(v=>v[1]).join("~"),
  ...
  it1[Symbol.iterator] = AVL.ITER_FWD_EQ_TO_LT
  it1.ITER_LB = 5
  it1.ITER_UB = 7
  expect(
    [...it1].map(v=>v[1]).join("~"),
  ...
  it1[Symbol.iterator] = AVL.ITER_REV_EQ_TO_GE
  it1.ITER_LB = 5
  it1.ITER_UB = 8
  expect(
    [...it1].map(v=>v[1]).join("~"),
  ...
  it1[Symbol.iterator] = AVL.ITER_REV_EQ_TO_GT
  it1.ITER_LB = 5
  it1.ITER_UB = 8
  expect(
    [...it1].map(v=>v[1]).join("~"),
